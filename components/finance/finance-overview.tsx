...
export function FinanceOverview() {
  ...
  //   { id: "1", name: "Savings Account", amount: 15000, category: "Cash", date: "2024-01-01" },
  //   { id: "2", name: "Investment Portfolio", amount: 25000, category: "Investments", date: "2024-01-01" },
  //   { id: "3", name: "Car", amount: 20000, category: "Vehicles", date: "2024-01-01" },
  // ])
  ...
  //   { id: "1", name: "Student Loan", amount: 15000, category: "Education", date: "2024-01-01" },
  //   { id: "2", name: "Credit Card", amount: 3000, category: "Credit", date: "2024-01-01" },
  // ])
  const [liabilities, setLiabilities] = useState<FinancialItem[]>(() => {
    if (typeof window !== 'undefined') {
  ...
  //   { id: "1", name: "Salary", amount: 6000, category: "Employment", date: "2024-01-01" },
  //   { id: "2", name: "Freelance", amount: 2000, category: "Self-Employment", date: "2024-01-01" },
  // ])
  const [incomes, setIncomes] = useState<FinancialItem[]>(() => {
    if (typeof window !== 'undefined') {
  ...
  //   { id: "1", name: "Stock Portfolio", amount: 25000, category: "Stocks", date: "2024-01-01" },
  //   { id: "2", name: "401k", amount: 45000, category: "Retirement", date: "2024-01-01" },
  // ])
